...
$("#inputfile").change(function () {
  ...
  r.onload = function () {
    //After reading, the data is saved in the result attribute of the object
...
function draw(data) {
  ...
  function redraw() {
    ...
    //     .range([innerHeight, 0]);
    // x-axis range
    // If all the numbers are too big, the gap cannot be opened
    ...
    if (long) {
      barInfo.tween("text", function (d) {
        var self = this;
        var str = d[divide_by] + "-" + d.name + "  Numerical value:";
